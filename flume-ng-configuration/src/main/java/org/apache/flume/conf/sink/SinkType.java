...
public enum SinkType {
  ...
  /**
   * Data center hdfs sink
   *
   * @see org.apache.flume.sink.xmen.DataCenterHDFSSink
   */
  DATACENTERHDFS("org.apache.flume.sink.xmen.DataCenterHDFSSink"),

  /**
   * maxwell hdfs sink
   *
   * @see org.apache.flume.sink.xmen.MaxwellHDFSSink
   */
  MAXWELLHDFS("org.apache.flume.sink.xmen.MaxwellHDFSSink");
